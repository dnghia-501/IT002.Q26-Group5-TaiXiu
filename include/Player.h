...
/*
Nhúng interface chiến thuật vào
*/
...
private:
    double bankroll;
    /*
    Số tiền vốn hiện tại của người chơi
...
public:
    ...
    */
    ...
    /*
    Cộng tiền khi thắng hoặc trừ tiền khi thua
    ...
    */
    ...
    int determineBetSide();
    /*
    Ví dụ trả về 0 là Xỉu, 1 là Tài
    */
};
